...
def sidebar():
    with st.sidebar:
        ...
        temperature = st.slider("Température (`max_tokens`):", min_value=0.0, max_value=2.0, value=st.session_state.get("TEMPERATURE", 1.0), step=0.1, help="Maximum number of tokens to consume")
