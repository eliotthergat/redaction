...
def sidebar():
    with st.sidebar:
        ...
        PARAMS["max_tokens"] = st.slider("Longueur maximale (`max_tokens`):", min_value=1, max_value=8000, value=2048, step=25)
        PARAMS["temperature"] = st.slider("Température (`randomness`)", min_value=0.0, max_value=2.0, value=1, step=0.01)
